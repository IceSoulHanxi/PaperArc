 ...
 *
 * Bytecode-verified 1.21.1: SplashPotionItem.use and LingeringPotionItem.use
 * only play their throw sound and delegate to super (ThrowablePotionItem.use),
 * which contains the single addFreshEntity call site. One mixin here therefore
 * covers splash potions, lingering potions and any other ThrowablePotionItem.
 */
