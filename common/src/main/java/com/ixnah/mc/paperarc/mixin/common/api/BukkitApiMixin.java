...
public abstract class BukkitApiMixin {
    ...
    @Unique
    public static org.bukkit.command.CommandSender createCommandSender(java.util.function.Consumer<? super net.kyori.adventure.text.Component> p0) {
    ...
    @Unique
    public static org.bukkit.inventory.Inventory createInventory(org.bukkit.inventory.InventoryHolder p0, int p1, net.kyori.adventure.text.Component p2) throws java.lang.IllegalArgumentException {
        return Bukkit.getServer().createInventory(p0, p1, p2);
    }
    @Unique
    ...
    @Unique
    public static org.bukkit.generator.ChunkGenerator.ChunkData createVanillaChunkData(org.bukkit.World p0, int p1, int p2) {
