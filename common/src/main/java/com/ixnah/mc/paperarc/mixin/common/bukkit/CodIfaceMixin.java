...
/**
 * B3-2：给 {@link org.bukkit.entity.Cod} 补上 paper 声明的父接口 {@code io.papermc.paper.entity.SchoolableFish}。
 */
@Mixin(targets = "org.bukkit.entity.Cod", remap = false)
public interface CodIfaceMixin extends io.papermc.paper.entity.SchoolableFish {
