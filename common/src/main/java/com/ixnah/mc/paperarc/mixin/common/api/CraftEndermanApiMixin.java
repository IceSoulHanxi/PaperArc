 ...
 * them as {@code entityData.set(DATA_*, v)} with private-static accessors.
 * {@code teleportRandomly} delegates to the protected vanilla
 * {@code EnderMan#teleport()}. All three members are opened by
