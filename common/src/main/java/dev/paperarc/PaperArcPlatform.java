 ...
 * <ul>
 *   <li>forge   -> {@code dev.paperarc.forge.PaperArcPlatformImpl}</li>
 *   <li>neoforge-> {@code dev.paperarc.neoforge.PaperArcPlatformImpl}</li>
 *   <li>fabric  -> {@code dev.paperarc.fabric.PaperArcPlatformImpl}</li>
 * </ul>
