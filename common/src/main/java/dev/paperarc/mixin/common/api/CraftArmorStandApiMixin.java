...
public abstract class CraftArmorStandApiMixin {
    ...
    public boolean canMove() {
        ...
        return dev.paperarc.bridge.ApiState.get(this.getHandle(), "paperarc.canMove", Boolean.TRUE);
    }

    @Unique
    public void setCanMove(boolean move) {
        dev.paperarc.bridge.ApiState.put(this.getHandle(), "paperarc.canMove", move);
    }

    @Unique
    public boolean canTick() {
        // Paper default: world.paperConfig().entities.armorStands.tick (defaults to true)
        return dev.paperarc.bridge.ApiState.get(this.getHandle(), "paperarc.canTick", Boolean.TRUE);
    }
    ...
    public void setCanTick(boolean tick) {
        ...
        dev.paperarc.bridge.ApiState.put(this.getHandle(), "paperarc.canTick", tick);
    }
