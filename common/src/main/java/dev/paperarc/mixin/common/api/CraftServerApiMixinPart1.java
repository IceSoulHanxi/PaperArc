...
import dev.paperarc.bridge.CraftPlayerProfile;
import dev.paperarc.bridge.api.SimpleMobGoals;
import dev.paperarc.bridge.scheduler.SimpleAsyncScheduler;
import dev.paperarc.bridge.scheduler.SimpleGlobalRegionScheduler;
import java.io.File;
