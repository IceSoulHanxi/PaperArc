 ...
 * dev.paperarc.bridge.ApiState; the vanilla default is computed exactly like Paper.
 */
...
public abstract class CraftEnderDragonApiMixin {
    ...
    public Location getPodium() {
        Object custom = dev.paperarc.bridge.ApiState.get(this, PAPERARC$PODIUM_KEY, null);
    ...
    public void setPodium(@Nullable Location location) {
        if (location == null) {
            dev.paperarc.bridge.ApiState.remove(this, PAPERARC$PODIUM_KEY);
            return;
        }
        ...
        dev.paperarc.bridge.ApiState.put(this, PAPERARC$PODIUM_KEY,
