...
public abstract class CraftTadpoleApiMixin {
    ...
    public boolean getAgeLock() {
        return dev.paperarc.bridge.ApiState.get(getHandle(), PAPERARC$AGE_LOCKED, Boolean.FALSE);
    }

    @Unique
    public void setAgeLock(boolean lock) {
        dev.paperarc.bridge.ApiState.put(getHandle(), PAPERARC$AGE_LOCKED, lock);
    }
}
